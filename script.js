...
const gallerySections = [
  ...
  {
    title: "OPC / Vibe Coding 产品实验",
    note: "把教程、内容、出海项目和 AI 工作流放在同一条产品验证链路里展示。",
    items: [
      {
        src: "./assets/gallery/thumbs/web/opc-vibecoding.jpg",
        full: "./assets/gallery/web/opc-vibecoding.png",
        href: "https://adongwanai.github.io/vibecoding/",
        title: "Vibe Coding 教程",
        note: "从 idea 到页面、工具、产品验证的公开教程",
      },
      {
        src: "./assets/gallery/thumbs/web/opc-lobster-diary.jpg",
        full: "./assets/gallery/web/opc-lobster-diary.png",
        href: "https://ccn7vpu5l5y8.feishu.cn/wiki/SheVwZ5xpio9ufkvum0cEh39nzb?from=from_copylink",
        title: "龙虾养成日记",
        note: "开源龙虾教程与日更实验",
      },
      {
        src: "./assets/gallery/thumbs/web/opc-moneyclaw.jpg",
        full: "./assets/gallery/web/opc-moneyclaw.png",
        href: "https://moneyclaw.me/",
        title: "龙虾赚钱日记",
        note: "MoneyClaw 出海与变现实验",
      },
      {
        src: "./assets/gallery/thumbs/web/opensource-adong-skills.jpg",
        full: "./assets/gallery/web/opensource-adong-skills.png",
...
const nodes = [
  ...
  },
  {
    ...
    images: [
      { src: "./assets/gallery/thumbs/web/opc-vibecoding.jpg", full: "./assets/gallery/web/opc-vibecoding.png", type: "教程", caption: "Vibe Coding 公开教程入口。" },
      { src: "./assets/gallery/thumbs/web/opc-moneyclaw.jpg", full: "./assets/gallery/web/opc-moneyclaw.png", type: "产品", caption: "MoneyClaw / 龙虾赚钱日记。" },
      { src: "./assets/gallery/thumbs/web/opc-lobster-diary.jpg", full: "./assets/gallery/web/opc-lobster-diary.png", type: "教程", caption: "龙虾养成日记与日更实验。" },
    ...
    links: [
      ...
      ["龙虾养成日记", "https://ccn7vpu5l5y8.feishu.cn/wiki/SheVwZ5xpio9ufkvum0cEh39nzb?from=from_copylink"],
      ["龙虾赚钱日记", "https://moneyclaw.me/"],
      ["阿东 Skills", "https://github.com/adongwanai/adong-skills"],
    ],
  },
];
